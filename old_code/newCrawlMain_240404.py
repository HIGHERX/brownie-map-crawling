...
from var_types_240404 import InitialStoreData, search_location_list, cafein_list

today_datetime = datetime.today().strftime("%Y%m%d%H%M%S")
today_date = datetime.today().strftime("%Y%m%d")
filename = './cafein24_storeInfo_by_crawling_240404_'+ today_datetime + '.csv'
