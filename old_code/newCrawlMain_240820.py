...
from var_types_240820 import InitialStoreData, search_location_list, icecream_key_list, photoshop_key_list, selflaundry_key_list, studycafe_key_list, convenience_key_list, ramen_key_list, cafe_key_list, stationary_key_list, petshop_key_list, fruit_key_list, etc_search_key_list

today_datetime = datetime.today().strftime("%Y%m%d%H%M%S")
today_date = datetime.today().strftime("%Y%m%d")
filename = './' + today_date + '/storeInfo_by_crawling_'+ today_datetime + '.csv'
...
# whole_search_key = petshop_key_list + fruit_key_list + etc_search_key_list
