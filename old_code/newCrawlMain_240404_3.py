...
from var_types_240404_3 import InitialStoreData, search_location_list, campling_list

today_datetime = datetime.today().strftime("%Y%m%d%H%M%S")
today_date = datetime.today().strftime("%Y%m%d")
filename = './camping_storeInfo_by_crawling_240404_'+ today_datetime + '.csv'
...
whole_search_key = campling_list
